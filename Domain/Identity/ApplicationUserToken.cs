...
{
    public class ApplicationUserToken : ApplicationUserToken<Guid>
    {
        #region 导航属性
    ...
    public abstract class ApplicationUserToken<TIdentityUserKey> : Microsoft.AspNetCore.Identity.IdentityUserToken<TIdentityUserKey>,
        IDomainEntity<TIdentityUserKey>, INotifyPropertyChanged, IPropertyChangeTrackable
        where TIdentityUserKey : struct, IEquatable<TIdentityUserKey>
    {
        ...
        /// 初始化用于跟踪属性变更所需的属性信息
        /// </summary>
        protected ApplicationUserToken()
        {
            //判断类型是否已经加入字典
