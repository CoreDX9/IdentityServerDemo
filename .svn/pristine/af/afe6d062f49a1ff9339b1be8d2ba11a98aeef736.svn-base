...
namespace IdentityServer.Areas.IdentityServer.Controllers.Account
{
    [SecurityHeaders]
    [Area("IdentityServer")]
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Login(LoginInputModel model, string button)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    return Redirect($"/Identity/Account/LoginWith2fa?ReturnUrl={WebUtility.UrlEncode(model.ReturnUrl)}&RememberMe={model.RememberLogin}");
                }
