...
$(function () {
    ...
    function menuItem() {
        ...
        $('.J_menuTab').each(function () {
            ...
            if ($eachThis.data('id') === dataUrl) {
                if (!$eachThis.hasClass('active')) {
                    $eachThis.addClass('active').addClass('text-themecolor').siblings('.J_menuTab').removeClass('active').removeClass('text-themecolor');
                    scrollToTab(this);
                    // 显示tab对应的内容区
        ...
        // 选项卡菜单不存在
        if (flag) {
            var str = '<a href="javascript:;" class="active text-themecolor J_menuTab" data-id="' + dataUrl + '">' + menuName + ' <i class="fa fa-times-circle J_closeTab"></i></a>';
            $('.J_menuTab').removeClass('active').removeClass('text-themecolor');
    ...
    function closeTab() {
        ...
        if ($this.parents('.J_menuTab').hasClass('active')) {
            ...
            if ($this.parents('.J_menuTab').next('.J_menuTab').length > 0) {
                ...
                $this.parents('.J_menuTab').next('.J_menuTab:eq(0)').addClass('active').addClass('text-themecolor');
            ...
            if ($this.parents('.J_menuTab').prev('.J_menuTab').length > 0) {
                ...
                $this.parents('.J_menuTab').prev('.J_menuTab:last').addClass('active').addClass('text-themecolor');
                $('.J_mainContent .J_iframe').each(function () {
                    if ($(this).data('id') === activeId) {
                        $(this).show().siblings('.J_iframe').hide();
                        return false;
            ...
            // 当前元素没有同胞
            if ($this.parents('.J_menuTab').siblings('.J_menuTab').length === 0) {
                //  移除当前选项卡
                $(this).parents('.J_menuTab').remove();
    ...
    function activeTab() {
        ...
        if (!$this.hasClass('active')) {
            ...
            $this.addClass('active').addClass('text-themecolor').siblings('.J_menuTab').removeClass('active').removeClass('text-themecolor');
            scrollToTab(this);
        }
    }
    ...
    $('.J_tabCloseAll').on('click', function () {
        ...
        $pageTabsContent.children("[data-id]").each(function () {
            $('.J_iframe[data-id="' + $(this).data('id') + '"]').remove();
            $(this).remove();
        });
