...
namespace IdentityServer.Areas.Manage.Controllers
{
    ...
    public class OrganizationsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Name,Description,ParentId,Id,Remark,OrderNumber,RowVersion,IsEnable,IsDeleted,CreationTime,LastModificationTime,CreationUserId,LastModificationUserId")] Organization organization)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("Name,Description,ParentId,Id,Remark,OrderNumber,RowVersion,IsEnable,IsDeleted,CreationTime,LastModificationTime,CreationUserId,LastModificationUserId")] Organization organization)
        {
