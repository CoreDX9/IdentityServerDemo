...
{
    public class ApplicationUserToken : ApplicationUserToken<Guid, Guid, Guid>
    {
    }

    public abstract class ApplicationUserToken<TIdentityUserKey, TIdentityRoleKey, TOrganizationKey> : IdentityUserToken<TIdentityUserKey>
        , IDomainEntity
