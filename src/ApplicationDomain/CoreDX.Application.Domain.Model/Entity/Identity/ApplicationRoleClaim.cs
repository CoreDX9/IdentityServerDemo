...
{
    public class ApplicationRoleClaim : ApplicationRoleClaim<Guid, Guid, Guid>
    {}

    public abstract class ApplicationRoleClaim<TIdentityRoleKey, TIdentityUserKey, TOrganizationKey> : IdentityRoleClaim<TIdentityRoleKey>
        , IDomainEntity<int>
