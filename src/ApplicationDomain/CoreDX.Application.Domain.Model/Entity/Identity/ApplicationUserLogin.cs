...
{
    public class ApplicationUserLogin : ApplicationUserLogin<Guid, Guid, Guid>
    {
    }

    public abstract class ApplicationUserLogin<TIdentityUserKey, TIdentityRoleKey, TOrganizationKey> : IdentityUserLogin<TIdentityUserKey>
        , IDomainEntity
