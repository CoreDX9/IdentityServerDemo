...
using IdentityServerAdmin.Admin.Api.AuditLogging;
...
namespace IdentityServerAdmin.Admin.Api.Helpers
{
    public static class StartupHelpers
    {
        ...
        public static void AddDbContexts<TIdentityDbContext, TConfigurationDbContext, TPersistedGrantDbContext,
            TLogDbContext, TAuditLoggingDbContext>(this IServiceCollection services, IConfiguration configuration, IWebHostEnvironment webHostEnvironment)
