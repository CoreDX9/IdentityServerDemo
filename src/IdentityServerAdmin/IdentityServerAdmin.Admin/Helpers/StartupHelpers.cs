...
using IdentityServerAdmin.Admin.ExceptionHandling;
using IdentityServerAdmin.Admin.Configuration;
using IdentityServerAdmin.Admin.Configuration.ApplicationParts;
using IdentityServerAdmin.Admin.Configuration.Constants;
...
using IdentityServerAdmin.Admin.Helpers.Localization;
using System.Linq;
using IdentityServerAdmin.Admin.EntityFramework.MySql.Extensions;
using IdentityServerAdmin.Admin.EntityFramework.Shared.Configuration;
using IdentityServerAdmin.Admin.EntityFramework.SqlServer.Extensions;
...
namespace IdentityServerAdmin.Admin.Helpers
{
    public static class StartupHelpers
    {
        ...
        public static void RegisterDbContexts<TIdentityDbContext, TConfigurationDbContext, TPersistedGrantDbContext, TLogDbContext, TAuditLoggingDbContext>(this IServiceCollection services, IConfiguration configuration, IWebHostEnvironment webHostEnvironment)
            ...
            where TAuditLoggingDbContext : DbContext, IAuditLoggingDbContext<AuditLog>
        {
            ...
            var dbFilePath = configuration.GetValue<string>("DataBaseFilePath");
            identityConnectionString += $@";AttachDbFileName={dbFilePath}\IdentityServerDb-{webHostEnvironment.EnvironmentName}.mdf";
