...
namespace CoreDX.Application.Service.Mappers
{
    public class ClientMapperProfile : Profile
    {
        public ClientMapperProfile()
        {
            ...
            //PagedLists
            CreateMap<IPagedList<ClientSecret>, ClientSecretsDto>(MemberList.Destination)
                .ForMember(x => x.ClientSecrets, opt => opt.MapFrom(src => src.ToList()));

            CreateMap<IPagedList<ClientClaim>, ClientClaimsDto>(MemberList.Destination)
                .ForMember(x => x.ClientClaims, opt => opt.MapFrom(src => src.ToList()));

            CreateMap<IPagedList<ClientProperty>, ClientPropertiesDto>(MemberList.Destination)
                .ForMember(x => x.ClientProperties, opt => opt.MapFrom(src => src.ToList()));
