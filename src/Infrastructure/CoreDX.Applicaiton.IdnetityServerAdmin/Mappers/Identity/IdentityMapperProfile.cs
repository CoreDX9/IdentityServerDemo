...
{
    public class IdentityMapperProfile : IdentityMapperProfile<UserDto<int>, int, RoleDto<int>, int, ApplicationUser, ApplicationRole, int, ApplicationUserClaim, ApplicationUserRole,
        ApplicationUserLogin, ApplicationRoleClaim, ApplicationUserToken, UsersDto<UserDto<int>, int>, RolesDto<RoleDto<int>, int>, UserRolesDto<RoleDto<int>, int, int>, UserClaimsDto<int>, UserProviderDto<int>,
        UserProvidersDto<int>, RoleClaimsDto<int>, UserClaimDto<int>, RoleClaimDto<int>>
    {
    }

    public abstract class IdentityMapperProfile<TUserDto, TUserDtoKey, TRoleDto, TRoleDtoKey, TUser, TRole, TKey, TUserClaim, TUserRole,
