...
namespace CoreDX.Applicaiton.IdnetityServerAdmin.Services
{
    public class ClientService : IClientService
    {
        ...
        public virtual async Task<int> AddClientAsync(ClientDto client)
        {
            ...
            var clientEntity = client.ToEntity(Mapper);
        ...
        public virtual async Task<ClientDto> GetClientAsync(int clientId)
        {
            ...
            var clientDto = client.ToModel(Mapper);
        ...
        public virtual async Task<ClientsDto> GetClientsAsync(string search, int page = 1, int pageSize = 10)
        {
            ...
            var clientsDto = pagedList.ToModel(Mapper);
        ...
        {
            var accessTokenTypes = ClientRepository.GetAccessTokenTypes().ToModel(Mapper);
        ...
        {
            var tokenExpirations = ClientRepository.GetTokenExpirations().ToModel(Mapper);
        ...
        {
            var tokenUsage = ClientRepository.GetTokenUsage().ToModel(Mapper);
        ...
        {
            var hashTypes = ClientRepository.GetHashTypes().ToModel(Mapper);
        ...
        {
            var secretTypes = ClientRepository.GetSecretTypes().ToModel(Mapper);
        ...
        {
            var protocolTypes = ClientRepository.GetProtocolTypes().ToModel(Mapper);
        ...
        public virtual async Task<int> AddClientSecretAsync(ClientSecretsDto clientSecret)
        {
            ...
            var clientSecretEntity = clientSecret.ToEntity(Mapper);
        ...
        public virtual async Task<ClientSecretsDto> GetClientSecretsAsync(int clientId, int page = 1, int pageSize = 10)
        {
            ...
            var clientSecretsDto = pagedList.ToModel(Mapper);
        ...
        public virtual async Task<ClientSecretsDto> GetClientSecretAsync(int clientSecretId)
        {
            ...
            var clientSecretsDto = clientSecret.ToModel(Mapper);
        ...
        public virtual async Task<ClientClaimsDto> GetClientClaimsAsync(int clientId, int page = 1, int pageSize = 10)
        {
            ...
            var clientClaimsDto = pagedList.ToModel(Mapper);
        ...
        public virtual async Task<ClientPropertiesDto> GetClientPropertiesAsync(int clientId, int page = 1, int pageSize = 10)
        {
            ...
            var clientPropertiesDto = pagedList.ToModel(Mapper);
        ...
        public virtual async Task<ClientClaimsDto> GetClientClaimAsync(int clientClaimId)
        {
            ...
            var clientClaimsDto = clientClaim.ToModel(Mapper);
        ...
        public virtual async Task<ClientPropertiesDto> GetClientPropertyAsync(int clientPropertyId)
        {
            ...
            var clientPropertiesDto = clientProperty.ToModel(Mapper);
        ...
        {
            var clientClaimEntity = clientClaim.ToEntity(Mapper);
        ...
        {
            var clientProperty = clientProperties.ToEntity(Mapper);
        ...
        {
            var clientPropertyEntity = clientProperty.ToEntity(Mapper);
