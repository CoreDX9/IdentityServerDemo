...
namespace IdentityServer.Areas.Manage.Controllers
{
    ...
    {
        private readonly ApplicationPermissionDbContext _context;
        private readonly IRequestHandlerInfo _requestHandlerInfo;

        public RequestAuthorizationRulesController(ApplicationPermissionDbContext context, IRequestHandlerInfo requestHandlerInfo)
        {
            _context = context;
        ...
        {
            var applicationIdentityDbContext = _context.RequestAuthorizationRules;
        ...
        private bool RequestAuthorizationRuleExists(int id)
        {
