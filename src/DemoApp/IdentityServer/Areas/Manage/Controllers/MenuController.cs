...
namespace IdentityServer.Areas.Manage.Controllers
{
    ...
    public class MenuController : Controller
    {
        ...
        {
            var ApplicationIdentityDbContext = _context.Menus.Include(m => m.Items);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Index,Title,Order,ParentId,Id,Remark,OrderNumber,RowVersion,IsEnable,IsDeleted,CreationTime,LastModificationTime,CreatorId,LastModificationUserId")] Menu menu)
        {
            if (id != menu.Id)
            {
                return NotFound();
