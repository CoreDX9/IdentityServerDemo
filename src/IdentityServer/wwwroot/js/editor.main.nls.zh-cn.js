...
define("vs/editor/editor.main.nls.zh-cn", {
	...
	"vs/base/browser/ui/list/listWidget": [
        "{0}。 使用导航键导航。",//Use the navigation keys to navigate
	],
	...
	"vs/editor/browser/widget/codeEditorWidget": [
        "光标数量被限制在 {0} 个。",//The number of cursors has been limited to {0}.
	],
	"vs/editor/browser/widget/diffEditorWidget": [
        "因为一个文件太大，无法比较文件。",//Cannot compare files because one file is too large.
	],
	"vs/editor/browser/widget/diffReview": [
		...
		"+ modified {0}: {1}",//
		"- original {0}: {1}",//
        "转到下一处差异",//Go to Next Difference
        "转到上一处差异",//Go to Previous Difference
	],
	...
	"vs/editor/contrib/contextmenu/contextmenu": [
        "显示编辑器上下文菜单",//Show Editor Context Menu
	],
	...
	"vs/editor/contrib/find/findController": [
        "查找",//Find
        "&&查找",//Find
        "在选中内容中查找",//Find With Selection
        "查找下一个",//Find Next
        "查找上一个",//Find Previous
        "查找下一个选中内容",//Find Next Selection
        "查找上一个选中内容",//Find Previous Selection
        "替换",//Replace
        "&&替换",//Replace
	],
