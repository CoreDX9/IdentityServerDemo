...
dotnet ef migrations add AddPermissionIdentityDbMigration -c ApplicationIdentityDbContext -p ../DbMigration -o Identity
dotnet ef migrations add AddPermissionIdentityDbMigration_v2 -c ApplicationIdentityDbContext -p ../DbMigration -o Identity
